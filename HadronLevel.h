...
private:
  ...
  bool   doHadronize, doDecay, doBoseEinstein, allowRH, closePacking, casimirScaling;
  ...
  //Extract string directions for casimir scaling
  vector< pair< pair<double,double>, pair<int,int> > > rapiditySpans(Event& event);
